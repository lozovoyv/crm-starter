    ...
    <LayoutPage :title="staff.title" :is-forbidden="staff.is_forbidden" :is-not-found="staff.is_not_found">
        ...
        <FormBox :form="staff">
            <div style="width: 50%; display: inline-block; vertical-align: top">
                <FormDictionary :form="staff" dictionary="users" name="user_id" search has-null
                                @change="userChanged"
                                null-caption="Создать новую учётную запись"
                ...
                <FormString :form="staff" name="display_name" :disabled="staff.values['user_id'] !== null"/>
...
function userChanged(userId: number | null, name: string, payload: any): void {
    ...
    staff.value.update('display_name', payload ? payload.display_name : null);
