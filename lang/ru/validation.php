...
return [
    ...
    'password' => [
        ...
        'symbols' => 'Поле :attribute должно содержать как минимум один специальный символ.',
        'uncompromised' => 'Введённый :attribute возможно скомпрометирован. Выберите другой :attribute.',
    ],
